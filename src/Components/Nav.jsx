        ...
        <nav>
          <div className="flex  bg-orange-500 py-2 gap-2 md:gap-10 ">
            ...
            <div className="flex mb-2 md:mb-0">
              ...
              <h1 className="ml-1">+91 7342890780</h1>
            </div>
            <div className="flex  ml-auto mr-1  gap-8 text-lg">
              <FaFacebookF />
              <FaTwitter />
              <RiInstagramFill />
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between">
            <img className="ml-2 mb-4 md:mb-0" src={img} alt="logo" style={{ width: "130px", height: "70px" }} />
